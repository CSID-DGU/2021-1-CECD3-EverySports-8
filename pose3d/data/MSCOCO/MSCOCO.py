...
class MSCOCO:
    def __init__(self, data_split):
        self.mount_data_dir = cfg.mount_data_dir
        self.data_split = data_split
        self.img_dir = osp.join(self.mount_data_dir, 'MSCOCO', 'images')
        self.train_annot_path = osp.join(self.mount_data_dir, 'MSCOCO', 'annotations', 'person_keypoints_train2017.json')
        self.test_annot_path = osp.join(self.mount_data_dir, 'MSCOCO', 'annotations', 'person_keypoints_val2017.json')
        self.human_3d_bbox_root_dir = osp.join(self.mount_data_dir, 'MSCOCO', 'bbox_root', 'bbox_root_coco_output.json')
