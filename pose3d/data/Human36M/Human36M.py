...
class Human36M:
    def __init__(self, data_split):
        ...
        self.img_dir = osp.join(self.mount_data_dir, 'Human36M', 'images')
        self.annot_path = osp.join(self.mount_data_dir, 'Human36M', 'annotations')
        self.human_bbox_root_dir = osp.join(self.mount_data_dir, 'Human36M', 'bbox_root', 'bbox_root_human36m_output.json')
