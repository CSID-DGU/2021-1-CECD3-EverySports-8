...
class MuPoTS:
    def __init__(self, data_split):
        ...
        self.img_dir = osp.join(self.mount_data_dir, 'MuPoTS', 'data', 'MultiPersonTestSet')
        self.test_annot_path = osp.join(self.mount_data_dir, 'MuPoTS', 'data', 'MuPoTS-3D.json')
        self.human_bbox_root_dir = osp.join(self.mount_data_dir, 'MuPoTS', 'bbox_root', 'bbox_root_mupots_output.json')
