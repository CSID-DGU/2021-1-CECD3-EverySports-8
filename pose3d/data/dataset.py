...
class DatasetLoader(Sequence):
    def __init__(self, db, ref_joints_name, is_train):
        self.db = db.data
    ...
    def __getitem__(self, index):
        ...
        if self.is_train:
            img_patch = trans_img_to_tensor(img_patch)
...
def trans_img_to_tensor(img_patch):
    """normalize image and convert image to tensor
    Args:
        img: np.float32
    """
